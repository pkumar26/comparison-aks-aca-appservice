# Decision Tree - Horizontal Layout (Left-Right)

This is the horizontal layout of the comprehensive Azure service decision tree, optimized for wide screens and left-to-right reading flow.

## How to Use

1. **Start on the left** with the legend to understand recommendation indicators
2. **Answer each question** in the decision nodes (diamonds)
3. **Follow Yes/No paths to the right** until you reach a recommendation box
...
- [Vertical Layout](decision-tree-vertical.md) - Top-bottom flowchart for scrolling
